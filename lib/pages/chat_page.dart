...
class _ChatPageState extends State<ChatPage> {
  ...
  void sendMessage() async {
    if (_messageController.text.isNotEmpty) {
      ...
      _sendNotification(widget.receiverUserEmail, _messageController.text);
    }
  }

  void _sendNotification(String receiverUserEmail, String message) async {
    try {
      // Get the FCM token of the receiver
      String? receiverFCMToken = await _getReceiverFCMToken(receiverUserEmail);
      ...
      if (receiverFCMToken != null) {
        ...
        var response = await http.post(
          ...
          headers: {
            'Authorization':
                'key=AAAAgRdqqPU:APA91bGmtN5F-0r96-5WBzl5TXyLedz5DYUXN3tE_CGSdnVVJiBERnJ9zoOKq0P5oqIwHL6Fh4pnSymInrC8XxdM9ls-fyRAgXCL96v5Vi8izv6veFpGlP-jc242Jwnw8h768_a2PCex',
